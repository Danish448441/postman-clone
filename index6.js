//utility function:1. to get get DOM element from string
...
// if tthe user clicks on + button add more parameters:
...
addParam.addEventListener('click', () => {
    ...
    //add an event lsitner to remove the parameter on clicking
...
submit.addEventListener('click',()=>{
    ...
    //if user has used params option insted of json, collect all the paraeters in an object:
